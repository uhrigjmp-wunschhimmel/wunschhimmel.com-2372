          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className={`w-full bg-input border rounded-xl px-4 py-3 font-body text-foreground outline-none focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all ${error ? "border-red-400" : "border-border"}`}
                placeholder="••••••••"
              />
            </div>
